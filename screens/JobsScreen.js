...
import { Text, StyleSheet, View, TextInput, Alert,
	...
	render() {
			...
			<View style={styles.container}>
				...
				<Animated.View style={{...styles.header, height:this.animatedHeaderHeight}}>
					<Animated.View style={{...styles.searchWrapper, top:this.animatedSearch}}>
						<MaterialIcons name="search" size={20} style={{marginRight:10}} color={'white'}/>
						<TextInput
        ...
        >
          ...
          <View style={{ height: 130, marginTop: 20 }}>
            <CategoryList parentCallback = {this.callbackCategoryList.bind(this)} />
          </View>
        </View>
        ...
        <View style={{ marginTop: 40 }}>
          ...
          {!this.state.isLoading&&this.state.jobsFound===0&&
            Alert.alert(
              'Not Found'
            )
          }
        ...
        {this.state.nextAble&&
        <Button full style={{backgroundColor:'#097392'}} onPress={()=>this.loadMore()}>
          <Text>Load more..</Text>
        </Button>
        }
        </ScrollView>
...
const categoryArray = [
	'Pendidikan', 'Kuliner', 'IT', 'Desain', 'Olah Raga', 'Kesenian', 'Programmer',
