...
import { Text, StyleSheet, View, TextInput, Dimensions, TouchableOpacity, Alert } from 'react-native'
...
export default class LoginScreen extends React.Component {
    ...
    .catch(err=>{
    	console.log(err)
    	const loginMessage = err.response.data.status + ', ' + err.response.data.message
		...
		return (
			<View style={styles.container}>
				...
				<View style={{marginTop:10}}>
					<MaterialIcons name="person-outline" size={28} color={'rgba(255,255,255,0.7)'}
				...
				<View style={{marginTop:10}}>
					<MaterialIcons name="lock-outline" size={28} color={'rgba(255,255,255,0.7)'}
					style={styles.inputIcon}/>
					<TextInput
						style={styles.input}
